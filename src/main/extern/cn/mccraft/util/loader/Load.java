 ...
 * You should add your custom loader in {@link cn.mccraft.chinacraft.common.CommonProxy#loaders}.
 * 被该注解注释的函数将被自动执行。
 * 你需要把你的自定义加载器放入{@link cn.mccraft.chinacraft.common.CommonProxy#loaders}。
 */
